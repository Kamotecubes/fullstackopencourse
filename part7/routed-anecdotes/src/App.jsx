...
const App = () => {
  ...
  const selectedAnecdote = match ? anecdotes.find(a => a.id === Number(match.params.id)) : null
    ...
    <>
      <h1>Software anecdotes</h1>
        ...
        <Routes>
          ...
          <Route path="/anecdotes/:id" element={<Anecdote anecdote={selectedAnecdote} />}></Route>
